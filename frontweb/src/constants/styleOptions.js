...
export const generationStyleOptions = [
  {
    label: 'Chân thực / Điện ảnh',
    options: [
      { label: 'Chân thực',    value: 'realistic',
      ...
      { label: 'Phim tài liệu',  value: 'documentary',
      ...
      { label: 'Phim cổ điển', value: 'retro film',
  ...
  },
  {
    ...
    options: [
      { label: 'Anime Nhật', value: 'anime style',
      ...
      { label: 'Comic Âu Mỹ', value: 'comic style',
      ...
      { label: 'Hoạt hình 2D', value: '2d animation',
      ...
      { label: 'Anime chân thực', value: 'realistic anime',
      ...
      { label: '3D đô thị', value: 'urban 3d',
  ...
  {
    label: 'Phong cách Trung Hoa',
    options: [
      { label: 'Thủy mặc', value: 'ink wash',
      ...
      { label: 'Trung Hoa cổ điển',  value: 'chinese style',
      ...
      { label: 'Cổ trang',    value: 'historical',
  ...
  {
    label: 'Manhua / Ngôn tình',
    options: [
      { label: 'Cổ phong 2D', value: '2d gufeng',
      ...
      { label: 'Tiên hiệp 3D', value: 'xianxia 3d',
      ...
      { label: 'Cổ phong 3D', value: 'gufeng 3d',
      ...
      { label: 'Tân Trung Hoa Guochao', value: 'neo chinese guochao',
      ...
      { label: 'Tân cổ phong', value: 'neo gufeng',
      ...
      { label: 'Manhua ngôn tình đô thị', value: 'urban romance comic',
      ...
      { label: 'Webtoon ngôn tình Hàn', value: 'korean romance webtoon',
  ...
  },
  {
    label: 'Hội hoạ',
    options: [
      { label: 'Màu nước',    value: 'watercolor',
      ...
      { label: 'Sơn dầu',    value: 'oil painting',
      ...
      { label: 'Tranh khắc gỗ',    value: 'woodblock print',
      ...
      { label: 'Ấn tượng',  value: 'impressionist',
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Hậu tận thế', value: 'post-apocalyptic',
